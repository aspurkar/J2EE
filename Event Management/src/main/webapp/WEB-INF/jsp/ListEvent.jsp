...
<table>
<th><input type="radio" id="all" value="Uncheck" onclick=
"document.getElementById('all').checked = false"/></th>
...
<c:forEach items="${eventList}" var="event">
	...
	<tr style="border: 1px solid black;">
		...
		<td><c:out value="${event.totalseats}"> </c:out></td>
		<td><c:out value="${event.description}"> </c:out></td>
		
	<!-- 	<td><img alt="View" src="/resour-->
	</tr>
	<%i++; %>
</c:forEach>
</table>
