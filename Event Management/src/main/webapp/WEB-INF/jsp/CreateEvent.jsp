	...
	<form action="event" method="post" id="opForm">
		...
		<div style="margin-left: 150px">
			<table>
				...
				<tr>
					<td>Description</td>
					<td><input type="text" class="txt" id="description"
						name="description" /></td>
				</tr>
				<tr>
					<td>Location</td>
					<td><input type="text" class="txt" id="location"
						name="location" /></td>
				</tr>
				<tr>
					<td>Time</td>
				...
				<tr>
					<td>Total Seats</td>
					<td><input type="number" id="totalseats" class="txt"
						name="totalseats" /></td>
				</tr>

			</table>
			<input type="button" class="btn" value="Create" name="Create"
				onclick="create();" /> <input type="button" class="btn" value="Back"
				name="Back" onclick="redirectSearch();" />
		</div>
	</form>
</body>
</html>
